...
private:
    static constexpr const char* SIGN_IN =  "https://api.wolksense.com/api/signIn";
    static constexpr const char* RANDOM_SER = "https://api.wolksense.com/api/v3/devices/random_serial?type=";
    static constexpr const char* ACTIVATE_DEV =  "https://api.wolksense.com/api/v2/devices/";
