 ...
 * Modifications copyright (C) 2016 <Execom/misavic>
 */
...
private:
    ...
    const std::string CERTIFICATE_NAME = "../configuration/ca.crt";

    const std::string HOST = "ssl://wolksense.com:8883";
    static constexpr const int QOS = 1;

    static constexpr const unsigned int WAIT_FOR_COMPLETITION_TIMEOUT = 30000;
